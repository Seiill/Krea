...
export const cardsData = [
    { id:'001',
    title: 'Escuchar',
    description: 'Nos sumergimos en tus ideas, necesidades y objetivos. Tu voz es nuestra brújula, y estamos aquí para captar cada detalle de tu visión.', 
    encendida: true,
    text:'texto t0'
},
    { id:'002',
    title: 'Analizar',
    description: ' Estudiamos cuidadosamente cada aspecto, evaluamos posibilidades y trazamos estrategias. Esta fase nos permite trazar el camino más sólido para convertir tu visión en realidad.',
    encendida: false,
    text:'texto t1' },
    { id:'003',
    title: 'Krear',
    description: 'Nuestro equipo creativo se sumerge en el proceso de dar forma a tus ideas, utilizando nuestra experiencia y creatividad para hacerlas cobrar vida',
    encendida: true,
    text:'texto t2' },
    { id:'004',
    title: 'Resolver',
    description: 'Nos comprometemos a superar desafíos, encontrar soluciones innovadoras y asegurar que tu proyecto se complete con excelencia y precisión.',
    encendida: true,
    text:'texto t3' },
  ];
  export const 
